 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/8969.c
 * Seed:      1036504122
 */
...
static int16_t g_8 = 0x7925L;
static union U1 g_9 = {0xC865B49D585ED065LL};/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    ...
    int16_t l_7 = 0x182AL;
    (*l_3) = l_2;
    g_8 |= (safe_sub_func_uint8_t_u_u((*l_3), l_7));
    return g_9;
}
