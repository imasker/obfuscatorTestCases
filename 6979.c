 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6979.c
 * Seed:      2743248378
 */
...
static volatile int32_t g_6 = 0xF20920A6L;/* VOLATILE GLOBAL g_6 */
static uint32_t g_7 = 0x2C930F88L;
...
{ /* block id: 0 */
    int32_t *l_2[10][6];
    const uint32_t l_10 = 0x06982B35L;
    int i, j;
    for (i = 0; i < 10; i++)
    {
        for (j = 0; j < 6; j++)
