 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6957.c
 * Seed:      1962887100
 */
...
static int32_t g_3 = 0xB68DEE21L;
static int32_t g_11 = 4L;
static struct S0 g_12 = {-22,-224,121,-19170,229,0,-1105};/* VOLATILE GLOBAL g_12 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    uint32_t l_7 = 0xE71B35D5L;
    for (g_3 = 0; (g_3 < 1); g_3++)
    { /* block id: 3 */
        uint64_t l_6[8] = {0x3267E6AA16542076LL,0x3267E6AA16542076LL,0x3267E6AA16542076LL,0x3267E6AA16542076LL,0x3267E6AA16542076LL,0x3267E6AA16542076LL,0x3267E6AA16542076LL,0x3267E6AA16542076LL};
        int32_t *l_10[1];
        int i;
        for (i = 0; i < 1; i++)
            l_10[i] = &g_11;
        ...
        {
            l_6[g_2] = 0x34EDF6B3E713E19FLL;
        }
        if (l_7)
            break;
        g_2 = (safe_add_func_int16_t_s_s(g_3, (1L > 65535UL)));
