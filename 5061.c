 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/5061.c
 * Seed:      2645035502
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile union U0 g_3 = {3UL};/* VOLATILE GLOBAL g_3 */
static const volatile union U0 * volatile g_2 = &g_3;/* VOLATILE GLOBAL g_2 */
...
static int8_t  func_1(void)
{ /* block id: 0 */
    const volatile union U0 * volatile *l_4 = &g_2;
    uint32_t l_5 = 0x15DE05DAL;
    (*l_4) = g_2;
    return l_5;
}
