 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7487.c
 * Seed:      3099843408
 */
...
static volatile uint64_t g_10 = 0x7084BC9C3D069F49LL;/* VOLATILE GLOBAL g_10 */
...
/* ------------------------------------------ */
/* 
 * reads : g_7 g_10 g_4 g_16
 * writes: g_7 g_10 g_16
 */
static int32_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    ...
    ++g_7;
    ++g_10;
    g_16 |= ((safe_mod_func_int8_t_s_s((+g_4), 1UL)) , g_10);
    return (*l_5);
}
