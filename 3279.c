 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/3279.c
 * Seed:      2721982750
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile uint8_t g_4 = 0x5DL;/* VOLATILE GLOBAL g_4 */
...
static int16_t  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0x56834504L;
    int32_t *l_3[9] = {&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2,&l_2};
    int i;
    --g_4;
    return g_4;
}
