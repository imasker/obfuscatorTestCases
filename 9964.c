 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/9964.c
 * Seed:      4273761212
 */
...
static volatile int32_t *g_2[9] = {&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3,&g_3};
static volatile int32_t ** const  volatile g_4 = &g_2[5];/* VOLATILE GLOBAL g_4 */
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    const int32_t l_5[1] = {0x114768C0L};
    int i;
    (*g_4) = g_2[7];
    return l_5[0];
}
