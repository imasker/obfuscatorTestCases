 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7196.c
 * Seed:      3751300836
 */
...
static uint32_t g_16 = 0xDB821342L;
...
/* ------------------------------------------ */
/* 
 * reads : g_6 g_18 g_19 g_17
 * writes: g_6 g_12 g_16 g_17 g_19
 */
static int64_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_4 = 0UL;
    ...
    uint32_t *l_15 = &g_16;
    (*g_18) ^= (((g_17 = ((*l_15) = ((safe_add_func_uint64_t_u_u(((*l_5) = (18446744073709551612UL ^ (l_4 >= ((-5L) >= 6L)))), (safe_rshift_func_uint16_t_u_s(((safe_mul_func_int8_t_s_s((0UL <= l_4), 0xAEL)) <= l_4), 8)))) , ((*l_11) = ((0x59C4L | g_6) > 65529UL))))) == 0xB5AF9F7CL) <= l_4);
    return g_17;
}
