 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6976.c
 * Seed:      3012896648
 */
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    const uint32_t l_10[8] = {4UL,4294967290UL,4UL,4294967290UL,4UL,4294967290UL,4UL,4294967290UL};
    int i;
    for (g_3[1] = 8; (g_3[1] > 17); g_3[1] = safe_add_func_uint32_t_u_u(g_3[1], 4))
    { /* block id: 3 */
        uint8_t l_6 = 246UL;
        int32_t *l_9 = &g_8;
        (*g_7) = l_6;
