 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7163.c
 * Seed:      1303534742
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x1F2C29A3L;/* VOLATILE GLOBAL g_2 */
...
{ /* block id: 0 */
    ...
    int32_t *l_8[1];
    int32_t l_9 = 1L;
    uint8_t l_10[8] = {250UL,250UL,250UL,250UL,250UL,250UL,250UL,250UL};
    int i;
    for (i = 0; i < 1; i++)
        l_8[i] = &g_4[0];
    (*l_5) = (g_2 | (g_4[1] = l_3));
