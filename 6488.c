 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6488.c
 * Seed:      3546803228
 */
...
static int32_t g_5 = 0xEC2DB221L;
...
{ /* block id: 0 */
    int16_t l_10 = (-1L);
    for (g_2[0] = 0; (g_2[0] < 29); g_2[0]++)
    { /* block id: 3 */
        for (g_5 = 0; (g_5 <= (-14)); g_5 = safe_sub_func_int32_t_s_s(g_5, 8))
        { /* block id: 6 */
            if (g_5)
                break;
        }
