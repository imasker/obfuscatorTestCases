 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/4876.c
 * Seed:      3681732378
 */
...
static struct S5 g_6 = {0x26FBD10CAAD90151LL,-2454,255UL,3L,1UL,0xA2L,{14},18446744073709551609UL,255UL,0x5540FFF0L};/* VOLATILE GLOBAL g_6 */
...
int main (int argc, char* argv[])
{
    ...
    transparent_crc(g_6.f6.f0, "g_6.f6.f0", print_hash_value);
