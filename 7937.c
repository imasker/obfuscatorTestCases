 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7937.c
 * Seed:      1373450166
 */
...
static volatile uint8_t g_15 = 0x92L;/* VOLATILE GLOBAL g_15 */
...
{ /* block id: 0 */
    int16_t l_9 = 0x672DL;
    uint64_t l_12 = 0xCD5467356A0B3493LL;
    for (g_3 = (-27); (g_3 > 1); g_3 = safe_add_func_int32_t_s_s(g_3, 9))
    { /* block id: 3 */
