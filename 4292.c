 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/4292.c
 * Seed:      2085665966
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[7] = {0xCDBE8E56L,2L,0xCDBE8E56L,0xCDBE8E56L,2L,0xCDBE8E56L,0xCDBE8E56L};
...
{ /* block id: 0 */
    ...
    uint64_t l_13 = 0xD0B5486B6FEB9E9DLL;
    int i;
    --l_13;
    (*l_2) = (g_19 ^= func_16(&g_3[4]));
    return g_3[3];
}
