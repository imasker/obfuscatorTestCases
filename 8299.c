 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/8299.c
 * Seed:      3167019686
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_6 = 0x68819570L;
static uint8_t g_9[2] = {0xF9L,0xF9L};
...
{ /* block id: 0 */
    ...
    int32_t *l_5 = &l_3;
    int32_t *l_7 = &g_6;
    int32_t *l_8[6] = {&l_4[4],&l_4[1],&l_4[1],&l_4[4],&l_4[1],&l_4[1]};
    int i;
    ++g_9[0];
    return g_9[0];
}
