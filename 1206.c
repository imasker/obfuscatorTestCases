 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/1206.c
 * Seed:      2282350032
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2[5] = {0x07222631L,0x07222631L,0x07222631L,0x07222631L,0x07222631L};
static int32_t g_7 = 0x02DAFBBDL;
...
{ /* block id: 0 */
    ...
    int i;
    for (i = 0; i < 5; i++)
        l_5[i] = 0x5165352F76EC7516LL;
    for (g_2[1] = 0; (g_2[1] != (-16)); --g_2[1])
    { /* block id: 3 */
        int32_t *l_6 = &g_7;
        int8_t *l_12 = &g_13;
        (*l_6) = l_5[4];
        (*l_6) = (safe_div_func_uint16_t_u_u(0x9F49L, (safe_add_func_int8_t_s_s(((*l_12) = (1UL <= (g_7 , 0x4EL))), (safe_rshift_func_uint8_t_u_s(1UL, 1))))));
    }
    return g_2[4];
}
