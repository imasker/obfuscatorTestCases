 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/207.c
 * Seed:      2305109250
 */
...
static int64_t g_13 = 0xC9214A9BACDE9E84LL;
static uint8_t g_14 = 1UL;
static uint32_t g_15 = 0x8BDFADF6L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 2; i++)
        l_4[i] = 0x8FL;
    g_15 |= (g_14 = (((*l_6) &= l_4[0]) || (l_10 == (!(l_4[1] <= ((*l_12) &= (l_10 >= l_10)))))));
    return g_7;
}
