 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/1915.c
 * Seed:      755501870
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile union U0 g_3 = {0xD9BACC5DL};/* VOLATILE GLOBAL g_3 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    volatile union U0 * volatile *l_4 = (void*)0;
    volatile union U0 * volatile *l_5 = &g_2;
    (*l_5) = g_2;
    return g_3.f0;
}
