 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/8552.c
 * Seed:      3160029352
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x779C63C4L;
static uint32_t g_7 = 0xAB227D37L;
...
static int16_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_2 = 0x2A831D26EC17E5C2LL;
    int32_t *l_3 = &g_4;
    int32_t *l_5 = (void*)0;
    int32_t *l_6[1][6] = {{&g_4,&g_4,&g_4,&g_4,&g_4,&g_4}};
    int i, j;
    (*l_3) = l_2;
    ++g_7;
    return (*l_3);
