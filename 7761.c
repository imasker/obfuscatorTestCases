 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7761.c
 * Seed:      2840654316
 */
...
static volatile uint64_t g_5 = 18446744073709551609UL;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    ...
    uint32_t *l_15 = &g_16;
    int32_t *l_17 = (void*)0;
    int32_t l_18 = 0xD5DE1FC6L;
    ++g_5;
    (*l_4) = (((*l_4) <= ((func_10(g_5) & 5L) , ((g_3 , (l_18 = (~((*l_15) = g_3)))) , (255UL == ((safe_add_func_uint64_t_u_u((~(safe_unary_minus_func_uint32_t_u(4294967295UL))), func_10(g_16))) , (*l_4)))))) , g_5);
    return g_5;
}
