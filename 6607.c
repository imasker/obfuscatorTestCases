 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6607.c
 * Seed:      1542978774
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[1][6] = {{0x2491E29EL,0x2491E29EL,0x2491E29EL,0x2491E29EL,0x2491E29EL,0x2491E29EL}};
...
{ /* block id: 0 */
    ...
    int32_t *l_6 = &g_3[0][3];
    int32_t *l_7[4];
    uint64_t l_8 = 0xBC3EC3D4E703026DLL;
    int16_t l_11[3];
    int i;
    for (i = 0; i < 4; i++)
        l_7[i] = &g_3[0][3];
