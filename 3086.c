 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/3086.c
 * Seed:      1494744734
 */
...
{ /* block id: 0 */
    uint8_t l_8 = 255UL;
    int32_t l_11 = (-9L);
    int32_t *l_12[8] = {&l_11,&l_11,&l_11,&l_11,&l_11,&l_11,&l_11,&l_11};
    uint32_t l_13[6];
    int i;
    for (i = 0; i < 6; i++)
        l_13[i] = 4294967293UL;
    (*g_9) ^= (safe_rshift_func_uint16_t_u_s((safe_sub_func_uint8_t_u_u((safe_mul_func_uint16_t_u_u(l_8, l_8)), 0xA9L)), 3));
    l_13[5]--;
    return g_10;
}
