 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/4837.c
 * Seed:      2757490870
 */
...
{ /* block id: 0 */
    ...
    uint16_t *l_7 = &g_8[2];
    int32_t l_14 = (-1L);
    l_14 ^= (+(safe_rshift_func_uint16_t_u_s(((*l_7) = l_5), (safe_unary_minus_func_uint32_t_u((g_13 = (safe_rshift_func_uint16_t_u_u((l_5 | g_12), 8))))))));
    return g_8[2];
}
