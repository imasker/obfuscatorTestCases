 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/8131.c
 * Seed:      191254592
 */
...
static int32_t g_22 = 0xC383C67EL;
static uint16_t g_23 = 0x2D7AL;
...
{ /* block id: 0 */
    ...
    int32_t *l_19 = &g_5;
    int32_t *l_20 = (void*)0;
    int32_t *l_21[1][1][8] = {{{&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5}}};
    int i, j, k;
    ++g_23;
    return (*l_12);
}
