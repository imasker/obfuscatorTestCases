 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/8928.c
 * Seed:      1200543470
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_7 = 0xFA8F90A3L;
static uint8_t g_10 = 0x60L;
static struct S0 g_13 = {0xF88E10E5L,0x53494ABC24891023LL,8UL,4294967295UL,-5L,1UL,1L,0x89A9L};/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    int32_t *l_8[4][7] = {{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7},{&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7}};
    int32_t l_9[3];
    int i, j;
    for (i = 0; i < 3; i++)
        l_9[i] = 0x9D60A221L;
    g_7 |= (safe_lshift_func_uint16_t_u_s((l_4 , (safe_mod_func_int8_t_s_s(l_4, 0xFDL))), 11));
    g_10++;
    return g_13;
}
