 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/5573.c
 * Seed:      2144693058
 */
...
static struct S0 g_7 = {162,-10,12,-107,2,0x00L};/* VOLATILE GLOBAL g_7 */
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_3 g_4 g_7
 * writes: g_4
 */
static struct S0  func_1(void)
{ /* block id: 0 */
    int32_t *l_6[1][4] = {{&g_4,&g_4,&g_4,&g_4}};
    int32_t **l_5 = &l_6[0][0];
    int i, j;
    (*g_3) ^= g_2;
    l_5 = l_5;
