 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/2403.c
 * Seed:      3227822036
 */
...
static int64_t g_8 = 0xE17B844A754320E3LL;
static volatile uint32_t g_9 = 0x9AAED6B6L;/* VOLATILE GLOBAL g_9 */
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    int32_t *l_4 = &g_3;
    int32_t *l_5[5][1] = {{&g_3},{&g_3},{&g_3},{&g_3},{&g_3}};
    int64_t l_6 = 0x8D3C891C5534BF8FLL;
    int i, j;
    g_9++;
    return g_3;
}
