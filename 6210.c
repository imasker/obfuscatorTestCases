 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6210.c
 * Seed:      2010314006
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[6] = {0L,8L,0L,0L,8L,0L};
static volatile int32_t g_10 = 0xA32FD2D1L;/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &g_3[1];
    int32_t *l_8 = &g_3[3];
    int32_t *l_9[10] = {&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2],&g_3[2]};
    uint16_t l_11 = 0UL;
    int i;
    l_11--;
    return (*l_2);
