 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/1834.c
 * Seed:      3235754172
 */
...
static uint8_t  func_1(void)
{ /* block id: 0 */
    int8_t l_5[5][1][4] = {{{0x68L,6L,0x68L,0x68L}},{{6L,6L,6L,6L}},{{6L,0x68L,0x68L,6L}},{{0x68L,6L,0x68L,0x68L}},{{6L,6L,6L,6L}}};
    int i, j, k;
    for (g_2 = 0; (g_2 > 9); ++g_2)
    { /* block id: 3 */
        (*g_6) &= l_5[1][0][2];
        for (g_7 = (-26); (g_7 <= (-5)); g_7 = safe_add_func_uint64_t_u_u(g_7, 9))
        { /* block id: 7 */
            if ((*g_6))
                break;
        }
