 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/807.c
 * Seed:      2722128712
 */
...
/* --- GLOBAL VARIABLES --- */
static uint32_t g_4 = 0x8B108F82L;
...
{ /* block id: 0 */
    int32_t l_7 = 9L;
    int16_t *l_8 = &g_9;
    g_10 &= (safe_rshift_func_uint8_t_u_s(g_4, (safe_lshift_func_uint16_t_u_s(l_7, (g_4 , ((*l_8) = 0xEF7DL))))));
    return l_7;
}
