 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/2131.c
 * Seed:      647754736
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0xDDD1D8F8L;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    uint8_t l_2[9][1][1] = {{{0x07L}},{{1UL}},{{0x07L}},{{1UL}},{{0x07L}},{{1UL}},{{0x07L}},{{1UL}},{{0x07L}}};
    int64_t *l_5 = (void*)0;
    int32_t l_6 = (-3L);
    int32_t l_7[9] = {1L,1L,1L,1L,1L,1L,1L,1L,1L};
    int32_t *l_9 = (void*)0;
    int32_t **l_8[1][2];
    int64_t l_10 = 0x5755261FC42FF18CLL;
    int i, j, k;
    for (i = 0; i < 1; i++)
    {
        for (j = 0; j < 2; j++)
    ...
    (*g_3) = l_2[7][0][0];
    l_7[2] ^= (((l_6 = l_2[7][0][0]) != 6UL) | 0x084BC9C3D069F498LL);
    g_3 = (void*)0;
    return l_10;
}
