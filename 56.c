 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/56.c
 * Seed:      2089647762
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3 = 0x2FF40FC0L;
static int8_t g_6 = 0xA9L;
static int16_t g_7 = 1L;
static uint16_t g_8 = 0x257EL;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 7; i++)
        l_16[i] = (void*)0;
    g_8++;
    (*l_2) = ((g_6 |= (safe_rshift_func_uint16_t_u_s(func_13(&l_4), 1))) >= (!1UL));
    return (*l_2);
}
