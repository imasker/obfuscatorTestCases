 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7529.c
 * Seed:      4255888940
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4[9] = {0xDEDB5CABL,0x811F07B4L,0xDEDB5CABL,0xDEDB5CABL,0x811F07B4L,0xDEDB5CABL,0xDEDB5CABL,0x811F07B4L,0xDEDB5CABL};
...
{ /* block id: 0 */
    ...
    int32_t *l_9 = &g_4[1];
    int32_t *l_10 = &l_8;
    int32_t *l_11[1][9] = {{&g_4[2],&g_4[2],&g_4[2],&g_4[2],&g_4[2],&g_4[2],&g_4[2],&g_4[2],&g_4[2]}};
    uint32_t l_12 = 0xB6F9B691L;
    int32_t l_15 = 0xF93BD5DEL;
    int i, j;
    l_12++;
    return l_15;
}
