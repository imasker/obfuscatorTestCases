 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/4914.c
 * Seed:      1810316188
 */
...
static volatile int8_t g_10[1] = {(-1L)};
static uint32_t g_11 = 0x47D228D5L;
...
{ /* block id: 0 */
    ...
    int16_t l_7 = 0x55CCL;
    int32_t *l_8 = &g_3;
    int32_t *l_9[9] = {&l_5,&g_3,&l_5,&g_3,&l_5,&g_3,&l_5,&g_3,&l_5};
    int i;
    g_11--;
    return g_11;
}
