 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/5950.c
 * Seed:      2205845958
 */
...
/* --- GLOBAL VARIABLES --- */
static int8_t g_5 = 0xA1L;
static int32_t g_8[10] = {1L,0x69576881L,1L,1L,0x69576881L,1L,1L,0x69576881L,1L,1L};
...
static const uint64_t  func_1(void)
{ /* block id: 0 */
    int64_t l_6 = 0x14173BF38C08872FLL;
    int32_t *l_7 = &g_8[0];
    (*l_7) = (+(safe_lshift_func_uint16_t_u_s(((l_6 = g_5) & (-1L)), 4)));
    return g_5;
}
