 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/3920.c
 * Seed:      3051167398
 */
...
static int32_t g_7 = 0xE505B0BBL;
...
static const int32_t  func_1(void)
{ /* block id: 0 */
    for (g_2 = 0; (g_2 > (-4)); g_2 = safe_sub_func_int8_t_s_s(g_2, 9))
    { /* block id: 3 */
        int16_t l_5 = (-1L);
        int32_t *l_6[2];
        int i;
