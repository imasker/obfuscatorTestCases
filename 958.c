 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/958.c
 * Seed:      2751169206
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x04800FA7L;
static volatile uint8_t g_9 = 0x38L;/* VOLATILE GLOBAL g_9 */
static volatile int64_t g_14 = 0xE665969A22DB785BLL;/* VOLATILE GLOBAL g_14 */
static volatile int32_t g_15 = 0xD3EC93CCL;/* VOLATILE GLOBAL g_15 */
static uint32_t g_16 = 0x068CD546L;
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 1; i++)
        l_8[i] = &g_4;
    g_9++;
    for (g_4 = (-23); (g_4 == (-15)); g_4 = safe_add_func_int8_t_s_s(g_4, 4))
    { /* block id: 4 */
        g_16++;
    }
    return g_16;
