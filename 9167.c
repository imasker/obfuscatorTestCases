 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/9167.c
 * Seed:      791757274
 */
...
static int64_t g_14 = 0xAAD901516EA3DE81LL;
static uint32_t g_15[4] = {0xB2BC8F96L,0xB2BC8F96L,0xB2BC8F96L,0xB2BC8F96L};
...
{ /* block id: 0 */
    ...
    int32_t *l_9 = &g_4;
    int32_t *l_10 = &l_7[0];
    int32_t *l_11[7] = {(void*)0,(void*)0,&l_7[2],(void*)0,(void*)0,&l_7[2],(void*)0};
    uint64_t l_18 = 0xB416C28CBD6CD538LL;
    int i;
    for (i = 0; i < 4; i++)
        l_7[i] = 0x37182ABBL;
    g_15[2]++;
