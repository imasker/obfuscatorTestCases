 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/5866.c
 * Seed:      944201344
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_5 = 0xAB3921DEL;/* VOLATILE GLOBAL g_5 */
static int32_t g_8 = 0xDBDA7FE6L;
...
{ /* block id: 0 */
    ...
    int32_t *l_13 = &g_8;
    int32_t *l_14 = &g_8;
    int32_t *l_15[5][6] = {{&g_8,&g_8,&g_8,&g_8,&g_8,&g_8},{&g_8,&g_8,&g_8,&g_8,(void*)0,&g_8},{&g_8,&g_8,&g_8,&g_8,&g_8,&g_8},{&g_8,&g_8,&g_8,&g_8,&g_8,&g_8},{&g_8,(void*)0,&g_8,&g_8,&g_8,&g_8}};
    int64_t l_16 = 1L;
    uint32_t l_17 = 0x5BF81606L;
    union U0 l_20 = {0x6496L};
    int i, j;
    l_12 ^= (l_2 , (g_11 = (((*l_7) = (safe_mod_func_uint8_t_u_u((g_5 == 0x80444555L), l_2))) < ((void*)0 != g_9))));
    --l_17;
    return l_20;
}
