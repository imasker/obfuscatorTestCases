 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7463.c
 * Seed:      2821070518
 */
...
static volatile int32_t g_3[2] = {0xDDD3F467L,0xDDD3F467L};
...
static int8_t  func_1(void)
{ /* block id: 0 */
    for (g_5 = 0; (g_5 == (-5)); g_5 = safe_sub_func_int64_t_s_s(g_5, 1))
    { /* block id: 3 */
