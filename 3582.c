 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/3582.c
 * Seed:      3752505180
 */
...
static int32_t g_7 = 0x39ED080CL;
static int32_t g_11[5] = {0x4B1B055CL,0x4B1B055CL,0x4B1B055CL,0x4B1B055CL,0x4B1B055CL};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        uint16_t l_12 = 0x68DEL;
        int32_t *l_13 = &g_7;
        for (g_7 = (-3); (g_7 == (-22)); g_7 = safe_sub_func_uint64_t_u_u(g_7, 7))
        { /* block id: 6 */
            int32_t *l_10 = &g_11[1];
            (*l_10) = 0xA3B3F365L;
        }
