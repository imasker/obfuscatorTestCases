 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/1425.c
 * Seed:      4047036350
 */
...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_4 = {1UL,15,0xA167C28CL,0xE2FE8172L,1UL,0UL,1L,-1L};
...
static uint64_t  func_1(void)
{ /* block id: 0 */
    struct S0 l_2[5] = {{8UL,27,0UL,0x68D526D2L,0x85L,65531UL,1L,5L},{8UL,27,0UL,0x68D526D2L,0x85L,65531UL,1L,5L},{8UL,27,0UL,0x68D526D2L,0x85L,65531UL,1L,5L},{8UL,27,0UL,0x68D526D2L,0x85L,65531UL,1L,5L},{8UL,27,0UL,0x68D526D2L,0x85L,65531UL,1L,5L}};
    int i;
    (*g_3) = l_2[4];
    return g_4.f3;
}
