 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7104.c
 * Seed:      2671658138
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xD149FEBBL;
...
static int8_t  func_1(void)
{ /* block id: 0 */
    uint32_t l_5 = 0xB6EB6B9DL;
    int32_t *l_8 = &g_2;
    for (g_2 = (-19); (g_2 < (-14)); ++g_2)
    { /* block id: 3 */
        l_5 = 0L;
    }
    (*l_8) = (safe_lshift_func_uint8_t_u_s(g_2, 1));
    return (*l_8);
}
