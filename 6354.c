 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6354.c
 * Seed:      16451626
 */
...
static uint16_t g_5[1][2][4] = {{{1UL,1UL,1UL,1UL},{1UL,1UL,1UL,1UL}}};
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t *l_4[6][3] = {{&l_2,&g_3,&l_2},{&l_2,&g_3,(void*)0},{&l_2,&l_2,&g_3},{&l_2,&g_3,&g_3},{&g_3,&g_3,(void*)0},{&l_2,&g_3,&l_2}};
        int i, j;
        --g_5[0][0][2];
    }
    return g_5[0][0][2];
