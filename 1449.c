 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/1449.c
 * Seed:      316035484
 */
...
static volatile int32_t g_4 = 0xF84B8114L;/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    int32_t *l_5[1][5];
    int8_t l_6 = (-1L);
    uint64_t l_7[4][3] = {{18446744073709551615UL,18446744073709551615UL,18446744073709551615UL},{0x07647F1A969AC54CLL,0xF5D870A3267E6AA1LL,0x07647F1A969AC54CLL},{18446744073709551615UL,18446744073709551615UL,18446744073709551615UL},{0x07647F1A969AC54CLL,0xF5D870A3267E6AA1LL,0x07647F1A969AC54CLL}};
    int i, j;
    for (i = 0; i < 1; i++)
    {
        for (j = 0; j < 5; j++)
