 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/9213.c
 * Seed:      3108307092
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_3 = {1796};/* VOLATILE GLOBAL g_3 */
...
static const uint64_t  func_1(void)
{ /* block id: 0 */
    volatile struct S0 * volatile *l_4 = &g_2;
    const int32_t l_5 = 0x4C8D3C89L;
    (*l_4) = g_2;
    return l_5;
}
