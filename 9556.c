 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/9556.c
 * Seed:      1766977896
 */
...
static struct S1 g_8 = {8185,-1289,-343};/* VOLATILE GLOBAL g_8 */
...
{ /* block id: 0 */
    int32_t *l_5 = &g_2;
    for (g_2 = 0; (g_2 < (-15)); g_2 = safe_sub_func_uint64_t_u_u(g_2, 8))
    { /* block id: 3 */
        g_6 = l_5;
    }
    return g_8;
