 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6970.c
 * Seed:      438712118
 */
...
static volatile uint16_t g_12 = 4UL;/* VOLATILE GLOBAL g_12 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3 g_5 g_12 g_11
 * writes: g_5 g_12
 */
static int8_t  func_1(void)
{ /* block id: 0 */
    int32_t *l_4 = &g_5;
    int8_t l_6[10] = {0x19L,(-1L),(-1L),(-1L),(-1L),0x19L,(-1L),(-1L),(-1L),(-1L)};
    int32_t l_9[1];
    int i;
    for (i = 0; i < 1; i++)
        l_9[i] = (-1L);
