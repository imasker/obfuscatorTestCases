 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/5881.c
 * Seed:      3781455922
 */
...
static int32_t g_8[4] = {0x42170591L,0x42170591L,0x42170591L,0x42170591L};
...
{ /* block id: 0 */
    int32_t *l_2 = &g_3;
    (*l_2) &= 0xF82FF40FL;
    for (g_3 = 24; (g_3 < (-29)); g_3 = safe_sub_func_int64_t_s_s(g_3, 1))
    { /* block id: 4 */
        int64_t l_9 = (-1L);
        int32_t l_10 = 0x0D018D30L;
        (*g_6) = g_3;
