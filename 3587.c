 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/3587.c
 * Seed:      379914574
 */
...
static int32_t g_6 = 0x63E8E1B8L;
static int32_t g_9 = (-5L);
static int32_t g_13 = 0xA8F90A3CL;
...
/* ------------------------------------------ */
/* 
 * reads : g_2 g_6 g_9 g_3 g_13
 * writes: g_2 g_6 g_9 g_13
 */
static uint16_t  func_1(void)
{ /* block id: 0 */
    volatile int32_t * volatile *l_4 = &g_2;
    (*l_4) = g_2;
    for (g_6 = 27; (g_6 == 6); g_6 = safe_sub_func_int8_t_s_s(g_6, 9))
    { /* block id: 4 */
