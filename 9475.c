 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/9475.c
 * Seed:      1955113374
 */
...
static union U1  func_1(void)
{ /* block id: 0 */
    int64_t l_5[7] = {0L,5L,0L,0L,5L,0L,0L};
    int32_t *l_6[8] = {&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7,&g_7};
    int i;
    g_7 &= (1L >= (safe_unary_minus_func_int32_t_s((safe_mod_func_int32_t_s_s(l_5[4], 0x244D513CL)))));
    return g_8;
}
