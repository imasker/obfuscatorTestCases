 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/6550.c
 * Seed:      224836576
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_2 = 0xDA7FE64FL;
static int32_t g_6 = 0x3414B58EL;
...
static uint32_t  func_1(void)
{ /* block id: 0 */
    const uint16_t l_9 = 0xE4A9L;
    for (g_2 = 0; (g_2 > (-13)); g_2 = safe_sub_func_int32_t_s_s(g_2, 2))
    { /* block id: 3 */
        (*g_5) = g_2;
    }
    (*g_5) = (safe_rshift_func_int8_t_s_u(l_9, 6));
    return g_6;
}
