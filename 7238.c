 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/7238.c
 * Seed:      882906072
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_7 = 0x39BA095AL;
static int32_t *g_9 = &g_7;
static int32_t ** volatile g_8 = &g_9;/* VOLATILE GLOBAL g_8 */
static int32_t g_12[1] = {0x0D0714ADL};
static int32_t ** const  volatile g_14[2][3][7] = {{{&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9}},{{&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9},{&g_9,&g_9,&g_9,&g_9,&g_9,&g_9,&g_9}}};
static struct S0 g_15 = {6700,5,0xACL,4,557};
...
{ /* block id: 0 */
    ...
    int32_t *l_10 = (void*)0;
    int32_t *l_11 = &g_12[0];
    uint16_t l_13 = 0xC3A0L;
    (*g_8) = func_2(l_5, l_5);
    (*l_11) = ((*g_9) |= 3L);
    l_11 = func_2(l_13, g_12[0]);
    return g_15;
}
