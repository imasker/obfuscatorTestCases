 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/8112.c
 * Seed:      1494187554
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t * volatile g_2[1][1] = {{(void*)0}};
static volatile int32_t * volatile * volatile g_3 = &g_2[0][0];/* VOLATILE GLOBAL g_3 */
...
{ /* block id: 0 */
    ...
    (*g_3) = g_2[0][0];
    (*g_3) = (*g_3);
    l_10 = (safe_add_func_int64_t_s_s((safe_rshift_func_uint8_t_u_u(0x7CL, 7)), (((safe_mul_func_uint16_t_u_u(l_10, l_10)) , l_11) & l_10)));
    (*l_12) &= (0xCDE9L >= 9L);
    return g_13;
}
