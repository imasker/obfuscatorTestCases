 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/9515.c
 * Seed:      4237053538
 */
...
static volatile uint32_t g_13 = 0x008B15E3L;/* VOLATILE GLOBAL g_13 */
...
{ /* block id: 0 */
    ...
    for (i = 0; i < 3; i++)
        l_8[i] = 4L;
    ++g_13;
    g_3 = ((l_16 == &l_6) && (safe_rshift_func_uint8_t_u_s(g_13, 0)));
    return g_13;
}
