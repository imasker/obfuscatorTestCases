 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/9155.c
 * Seed:      1820776780
 */
...
static int32_t g_9 = 0x50270F9EL;
...
{ /* block id: 0 */
    int32_t *l_2 = (void*)0;
    int64_t l_3 = 0x5D811F07B4BC662ALL;
    int32_t l_4 = 0xDEDB5CABL;
    int32_t *l_5 = &l_4;
    int32_t *l_6[4][3] = {{&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4},{&l_4,&l_4,&l_4}};
    uint32_t l_10 = 4UL;
    int i, j;
    l_10++;
    return g_8;
