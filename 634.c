 ...
 * Git version: 30dccd7
 * Options:   -o /home/x/obfuscator/data/programs/634.c
 * Seed:      695264290
 */
...
/* --- GLOBAL VARIABLES --- */
static volatile uint64_t g_3 = 0x15E314A5EA964A90LL;/* VOLATILE GLOBAL g_3 */
static int32_t g_5 = 0xD4309642L;
...
static int32_t  func_1(void)
{ /* block id: 0 */
    uint64_t l_2 = 0x2858905B8B78ACC4LL;
    int32_t *l_4 = &g_5;
    (*l_4) &= (l_2 >= g_3);
    for (g_5 = 0; (g_5 > 7); g_5++)
    { /* block id: 4 */
